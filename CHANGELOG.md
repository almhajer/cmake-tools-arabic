...
Initial Arabic fork release:
- Rebrand the extension package as `cmake-tools-arabic`.
- Add an Arabic README tailored for GitHub and VSIX distribution.
- Prepare the project for standalone GitHub releases while preserving the upstream CMake Tools functionality.
